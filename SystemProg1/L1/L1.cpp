...
void start()
{
	...
	hEventStop = CreateEvent(NULL, TRUE, FALSE, "stopEvent");
	hEventStart = CreateEvent(NULL, TRUE, FALSE, "startEvent");
	hEventConfirm = CreateEvent(NULL, TRUE, FALSE, "confirmEvent");
	hEventQuit = CreateEvent(NULL, TRUE, FALSE, "quitEvent");
